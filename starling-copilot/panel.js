...
const STYLE_GUIDE =
  ...
  '- METRIC UNITS: a metric unit stuck to (or following) a number is written as its Hebrew abbreviation with ONE space (keep the digit): "kg" → "ק\\"ג", "km" → "ק\\"מ", "cm" → "ס\\"מ", "mm" → "מ\\"מ", "mg" → "מ\\"ג", "ml" → "מ\\"ל", "cc" → "סמ\\"ק", "km/h" → "קמ\\"ש". E.g. "450kg" → "450 ק\\"ג", "5 cm" → "5 ס\\"מ". Always a space between the number and the unit. Data sizes (KB/MB/GB/TB), "%", resolutions (1080p/4K) stay Latin as above.\n' +
